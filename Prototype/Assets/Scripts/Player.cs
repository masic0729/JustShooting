...
public class Player : Character
{
    ...
    void ShootCommmonBullet(CurrentPlayerBullet currentState) //일반 총알공격
    {
    ...
    void SetCommonBulletData(ref GameObject commonBullet) //총알의 리소스에 대한 데이터를 불러와 발사하려는 총알에 저장
    {
